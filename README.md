...
- **Telegram poll** (every 1 min): processes bot commands (`/add`, `/remove`, `/list`, `/analyze`)
- **Outcome tracker** (daily after market close): checks whether logged analyses hit TP, SL, or expired
